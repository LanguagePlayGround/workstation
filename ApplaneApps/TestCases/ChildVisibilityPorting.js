...
//                        if (colObj.visibility && colObj.visibility == "Child") {
//                            if (colObj.filter && Object.keys(colObj.filter).length == 1 && !customization.maintableid) {
//                                var columnFilter = colObj.filter;
//                                for (var exp in columnFilter) {
//                                    var filterValue = columnFilter[exp];
//                                    filterValue = filterValue.substr(1, filterValue.lastIndexOf("__id") - 1);
//                                    customization.maintableid = filterValue;
//                                }
//                            }
//                            if (colObj.filter) {
//                                hasChild = true;
...
//                                if (Object.keys(colObj.filter).length == 1) {
//                                    newChild.tableid = customization.maintableid;
//                                    newChild.filter = colObj.filter;
//                                    newChild.parametermappings = colObj.parametermappings;
