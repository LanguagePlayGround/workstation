...
pl.controller('pl-form-controller', function ($scope, $compile) {
    try {
        ...
        if ($scope.formOptions.close) {
            ...
            $scope.toolBarOptions.header.right.push({template: '<div ng-click="close()" class="pl-cancel-btn app-cursor-pointer" title="Close">Cancel</div>', class: "flex-1 app-text-align-right"});
        }
