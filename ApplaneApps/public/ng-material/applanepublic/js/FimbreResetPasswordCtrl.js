...
app.controller('FimbreResetPasswordCtrl', function ($scope, $compile, $timeout, $http) {
    $scope.password = "";
    ...
    $scope.resetPassword = function () {
        ...
        if (password.trim().length < 6) {
            $scope.errorMessage = 'Password is too short (we need a minimum of 6 characters here.)';
            return false;
        }
        ...
        if (password === confirmPassword) {
            ...
            return ApplaneDB.callRemoveService(domain+"/rest/invoke", {"user_access_token": url[1], "function": "FimbreUser.changePassword", "parameters": [
                {"password": password}
