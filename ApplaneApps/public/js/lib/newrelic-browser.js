window.NREUM || (NREUM = {}), __nr_require = function (t, e, n) {
    ...
    var a = t("handle"), s = window, c = s.document, f = "addEventListener", u = "attachEvent", d = ("" + location).split("?")[0], p = e.exports = {offset: i(), origin: d, features: {}};
...
}, {1: 20, ee: "QJf3ax"}]}, {}, ["G9z0Bl", 3, 10, 4]);
;
NREUM.info = {beacon: "bam.nr-data.net", errorBeacon: "bam.nr-data.net", licenseKey: "e86e53a5a3", applicationID: "5350852", sa: 1, agent: "js-agent.newrelic.com/nr-476.min.js"}