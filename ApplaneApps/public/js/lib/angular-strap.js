...
// '<span ng-if="title"><strong ng-bind="title"></strong>&nbsp;</span><span ng-bind-html="content"></span>' +
    angular.module('mgcrea.ngStrap.alert', ['mgcrea.ngStrap.modal']).provider('$alert',
        function () {
...
// Source: /Users/olivier/Dropbox/Projects/angular-strap/src/aside/aside.js
    angular.module('mgcrea.ngStrap.aside', ['mgcrea.ngStrap.modal']).provider('$aside',
        function () {
            var defaults = this.defaults = {
...
// Source: /Users/olivier/Dropbox/Projects/angular-strap/src/button/button.js
    angular.module('mgcrea.ngStrap.button', ['ngAnimate']).provider('$button',
        function () {
            var defaults = this.defaults = {
                activeClass:'active',
                toggleEvent:'click'
                    ...
                    var views = [
                        {
                            ...
                            onKeyDown:function (evt) {
                                ...
                                if (evt.keyCode === 37) newDate = new Date(actualTime - 1 * 864e5);
                                    ...
                                    newDate = picker.$date;
                                    if (!this.isDisabled(newDate)) picker.select(newDate, false);
                                    return;
                                }
                                picker.$date = newDate;
...
// Source: /Users/olivier/Dropbox/Projects/angular-strap/src/dropdown/dropdown.js
    angular.module('mgcrea.ngStrap.dropdown', ['mgcrea.ngStrap.tooltip']).provider('$dropdown',
        function () {
            var defaults = this.defaults = {
                animation:'am-fade',
...
// Source: /Users/olivier/Dropbox/Projects/angular-strap/src/helpers/debounce.js
    angular.module('mgcrea.ngStrap.helpers.debounce', []).constant('debounce',
        ...
        this.$get = [
            ...
            function ($parse, $q) {
                function ParseOptionsFactory(attr, config) {
                    ...
                    $parseOptions.getParseValue = function (value, typeaheadOptions) {
                        var values = [];
                        values.push(value);
                        $parseOptions.$values = values ? parseValues(values, typeaheadOptions) : {};
                        return $parseOptions.$values;
                    ...
                    // Private functions
                    function parseValues(values, typeaheadOptions) {
                        return values.map(function (match, index) {
                            var locals = {}, label, value;
                            locals[valueName] = match;
                            label = displayFn(locals);
                            if (typeaheadOptions && typeaheadOptions.otherDisplayFields && typeaheadOptions.otherDisplayFields != "undefined") {
                                var otherSupportiveValue = typeaheadOptions.otherDisplayFields.split(',');
                                for (var i = 0; i < otherSupportiveValue.length; i++) {
                                    if (angular.isDefined(locals[valueName][otherSupportiveValue[i]]) && angular.isDefined(label)) {
                                        label += ' | ' + locals[valueName][otherSupportiveValue[i]];
                                    }
                                }
                            }
...
// Source: /Users/olivier/Dropbox/Projects/angular-strap/src/modal/modal.js
    angular.module('mgcrea.ngStrap.modal', ['mgcrea.ngStrap.helpers.dimensions']).provider('$modal',
        function () {
            var defaults = this.defaults = {
                animation:'am-fade',
...
// Source: /Users/olivier/Dropbox/Projects/angular-strap/src/navbar/navbar.js
    angular.module('mgcrea.ngStrap.navbar', []).provider('$navbar',
        function () {
            var defaults = this.defaults = {
                activeClass:'active',
...
// Source: /Users/olivier/Dropbox/Projects/angular-strap/src/popover/popover.js
    angular.module('mgcrea.ngStrap.popover', ['mgcrea.ngStrap.tooltip']).provider('$popover',
        function () {
            var defaults = this.defaults = {
                animation:'am-fade',
                placement:'right',
            ...
            return {
                ...
                link:function postLink(scope, element, attr, controller) {
                    ...
                    controller.$render = function () {
                        ...
                        var selected, index;
                        if (options.multiple && angular.isArray(controller.$modelValue)) {
                            selected = controller.$modelValue.map(
                                function (value) {
                ...
                function ($window, $document, $rootScope, dimensions, debounce, throttle) {
                    ...
                    function ScrollSpyFactory(config) {
                        ...
                        $scrollspy.checkOffsets = function () {
                            ...
                            sortedElements = trackedElements.filter(
                                function (el) {
...
//                            var selected = angular.isDefined(index) ? typeahead.$scope.$matches[index].label : controller.$viewValue;
                    ...
                    function getSelectedValue(value) {
                        var selectedValue = parsedOptions.getParseValue(value, options);
