var pl = (pl === undefined) ? angular.module('pl', ['ngAnimate', 'ngSanitize', 'mgcrea.ngStrap']) : pl;
    pl.directive('angularAccordion', function() {
        return {
            restrict: 'EA',
            transclude: true,
            replace: true,
    ...
    pl.directive('paneHeader', ['$window', 'Debounce', function($window, Debounce) {
    return {
        restrict: 'EA',
    ...
    pl.directive('paneContent', function() {
        return {
            restrict: 'EA',
            require: '^paneHeader',
            transclude: true,
