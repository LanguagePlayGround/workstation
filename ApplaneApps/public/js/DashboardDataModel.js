...
(function (definition) {
    ...
    DashboardDataModel.prototype.refresh = function (callback) {
        ...
        return runQueryGroupWise(that, viewOptions, views, aggregates, queryGroups, db, callback);
    }
    ...
    function runQueryGroupWise(dashboardDatamodel, dashboardOptions, views, aggregates, queryGroups, db, callback) {
        ...
        return Utility.asyncIterator(keys, function (index, groupName) {
            ...
            return db.batchQuery(batchQueries).then(function (result) {
                if (dashboardDatamodel && dashboardDatamodel.metadata) {
    ...
    DashboardDataModel.prototype.cleanDataModel = function () {
        if (this.metadata && this.metadata.viewOptions && this.metadata.viewOptions.views) {
            delete this.metadata.viewOptions.views;
        }
        if (this.metadata && this.metadata.viewOptions) {
            delete this.metadata.viewOptions;
        }
        if (this.metadata) {
