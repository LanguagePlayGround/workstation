...
(function () {
  ...
  function MdAutocompleteCtrl ($scope, $element, $q, $mdUtil, $mdConstant) {
    ...
    var self = this,
      ...
      console.log("$scope.itemText"+$scope.itemText);
    ...
    function getDisplayValue (item) {
        var arg = getItemScope(item);
        var vv = $scope.itemText(arg);
        var value  = (item && $scope.itemText) ? $scope.itemText(getItemScope(item)) : item;
