...
function FileRetriever(e) {
    e = e || {}, this.options = {maxSize: void 0 != e.maxSize ? e.maxSize : 1048576, html5: void 0 != e.html5 ? e.html5 : !0}, this.timeout = Number(e.timeout) || 3e4, this.headers = {Accept: "application/json"}, this.scriptUrl = e.scriptUrl || "fileretriever.php", this.notify = e.notify || void 0, this.defaultFilename = "document.json", this.dom = {}
}
...
function newFeatureInfo() {
    if (!localStorage.hideOnlineStorageMessage && new Date < new Date(2014, 10, 1)) {
        var e = app.notify.showMessage({type: "notification", closeButton: !0, message: '<p><span style="color: red;">NEW:</span> JSON Editor Online now features <b>online document storage!</b></p><p>You can load and save documents via the top right menu. Stored documents can be shared via their url. <a href="doc/index.html#main_menu" target="_blank">Click here</a> to read more.</p><p><input type="button" id="gotIt" value="Ok, got it"/></p>'});
...
!function (e, t) {
    ...
    return function (e) {
        ...
        n.prototype._updateEditability = function () {
            ...
            var t, i, o, r, l, c, h, u, d, g, f, p, m, v, w = e.pageY, A = e.pageX, C = !1;
            if (t = this.dom.tr, d = s.getAbsoluteTop(t), p = t.offsetHeight, d > w) {
                ...
                if (u && u.parent) {
                    var E = A - this.drag.mouseX, y = Math.round(E / 24 / 2), F = this.drag.level + y, b = u.getLevel();
            ...
            if (this.parent && this.parent._hasChilds()) {
                ...
                i == l[l.length - 1] && s.push({text: "Append", title: "Append a new field with type 'auto' after this field (Ctrl+Shift+Ins)", submenuTitle: "Select the type of the field to be appended", className: "append", click: function () {
                    i._onAppend("", "", "auto")
                }, submenu: [
                ...
                for (var p, m, v, w, A, C, E, y, F, b = {}; ;) {
                    if (v = o[o.length - 1], this.defaultActions[v] ? w = this.defaultActions[v] : (null == p && (p = i()), w = a[v] && a[v][p]), "undefined" == typeof w || !w.length || !w[0]) {
                        if (!u) {
                            ...
                            var x = "";
                            x = this.lexer.showPosition ? "Parse error on line " + (c + 1) + ":\n" + this.lexer.showPosition() + "\nExpecting " + F.join(", ") + ", got '" + this.terminals_[p] + "'" : "Parse error on line " + (c + 1) + ": Unexpected " + (1 == p ? "end of input" : "'" + (this.terminals_[p] || p) + "'"), this.parseError(x, {text: this.lexer.match, token: this.terminals_[p] || p, line: this.lexer.yylineno, loc: f, expected: F})
                        }
                        if (3 == u) {
                    ...
                    switch (w[0]) {
                        case 1:
                            ...
                            break;
                        case 2:
                            if (E = this.productions_[w[1]][1], b.$ = r[r.length - E], b._$ = {first_line: s[s.length - (E || 1)].first_line, last_line: s[s.length - 1].last_line, first_column: s[s.length - (E || 1)].first_column, last_column: s[s.length - 1].last_column}, A = this.performAction.call(b, l, h, c, this.yy, w[1], r, s), "undefined" != typeof A)return A;
        ...
        !function () {
            ...
            var w = Object("a"), A = "a" != w[0] || !(0 in w);
            if (Array.prototype.forEach || (Array.prototype.forEach = function (e) {
                var t = O(this), i = A && "[object String]" == p(this) ? this.split("") : t, n = arguments[1], o = -1, r = i.length >>> 0;
                if ("[object Function]" != p(e))throw new TypeError;
                for (; ++o < r;)o in i && e.call(n, i[o], o, t)
            }), Array.prototype.map || (Array.prototype.map = function (e) {
                var t = O(this), i = A && "[object String]" == p(this) ? this.split("") : t, n = i.length >>> 0, o = Array(n), r = arguments[1];
                ...
                var t = O(this), i = A && "[object String]" == p(this) ? this.split("") : t, n = i.length >>> 0, o = arguments[1];
                if ("[object Function]" != p(e))throw new TypeError(e + " is not a function");
                ...
                var t = O(this), i = A && "[object String]" == p(this) ? this.split("") : t, n = i.length >>> 0;
                if ("[object Function]" != p(e))throw new TypeError(e + " is not a function");
                ...
                var t = A && "[object String]" == p(this) ? this.split("") : O(this), i = t.length >>> 0;
                if (!i)return-1;
                var n = 0;
            ...
            if (Object.defineProperty) {
                var y = o({}), F = "undefined" == typeof document || o(document.createElement("div"));
                if (!y || !F)var b = Object.defineProperty
            }
            if (!Object.defineProperty || b) {
                var x = "Property description must be an object: ", S = "Object.defineProperty called on non-object: ", D = "getters & setters can not be defined on this javascript engine";
            ...
            if (Object.preventExtensions || (Object.preventExtensions = function (e) {
                ...
                var $ = !0, k = ["toString", "toLocaleString", "valueOf", "hasOwnProperty", "isPrototypeOf", "propertyIsEnumerable", "constructor"], _ = k.length;
                for (var L in{toString: null})$ = !1;
            ...
            var n = e("../lib/event"), o = e("../lib/useragent"), r = e("../lib/dom"), s = e("../lib/lang"), a = o.isChrome < 18, l = o.isIE, c = function (e, t) {
                ...
                var D = function (e) {
                    g ? g = !1 : y(u) ? (t.selectAll(), i()) : B && i(t.selection.isEmpty())
                }, B = null;
                ...
                var $ = !1, k = function (e) {
                    B && (e = B(e), B = null), f ? (i(), e && t.onPaste(e), f = !1) : e == d.charAt(0) ? $ ? t.execCommand("del", {source: "ace"}) : t.execCommand("backspace", {source: "ace"}) : (e.substring(0, 2) == d ? e = e.substr(2) : e.charAt(0) == d.charAt(0) ? e = e.substr(1) : e.charAt(e.length - 1) == d.charAt(0) && (e = e.slice(0, -1)), e.charAt(e.length - 1) == d.charAt(0) && (e = e.slice(0, -1)), e && t.onTextInput(e)), $ && ($ = !1)
                }, _ = function (e) {
                    if (!p) {
                        var t = u.value;
                        k(t), c()
                    ...
                    var r = t.getCopyText();
                    return r ? void(L(e, r) ? (o ? t.onCut() : t.onCopy(), n.preventDefault(e)) : (g = !0, u.value = r, u.select(), setTimeout(function () {
                ...
                n.addCommandKeyListener(u, t.onCommandKey.bind(t)), n.addListener(u, "select", D), n.addListener(u, "input", _), n.addListener(u, "cut", T), n.addListener(u, "copy", M), n.addListener(u, "paste", O), "oncut"in u && "oncopy"in u && "onpaste"in u || n.addListener(e, "keydown", function (e) {
                ...
                n.addListener(u, "compositionstart", N), o.isGecko ? n.addListener(u, "text", function () {
                    ...
                    $ = !0, i(t.selection.isEmpty()), t._emit("nativecontextmenu", {target: t, domEvent: e}), this.moveToMouse(e, !0)
            ...
            function n(e) {
                function t(e, t) {
                    ...
                    if (!B || n || r)m.$blockScrolling += 1, m.moveCursorToPosition(e), m.$blockScrolling -= 1, B = i, $ = {x: C, y: E}; else {
                        var s = o($.x, $.y, C, E);
                ...
                function i(e, t) {
                    ...
                    u || d && !g ? D ? i - D >= l && m.renderer.scrollCursorIntoView(h) : D = i : D = null
                }
                ...
                function u() {
                    F = m.selection.toOrientedRange(), A = m.session.addMarker(F, "ace_selection", m.getSelectionStyle()), m.clearSelection(), m.isFocused() && m.renderer.$cursorLayer.setBlinking(!1), clearInterval(y), n(), y = setInterval(n, 20), _ = 0, s.addListener(document, "mousemove", g)
                }

                function d() {
                    clearInterval(y), m.session.removeMarker(A), A = null, m.$blockScrolling += 1, m.selection.fromOrientedRange(F), m.$blockScrolling -= 1, m.isFocused() && !S && m.renderer.$cursorLayer.setBlinking(!m.getReadOnly()), F = null, b = null, _ = 0, D = null, B = null, s.removeListener(document, "mousemove", g)
                }
                ...
                var A, C, E, y, F, b, x, S, D, B, $, k = m.container, _ = 0;
                this.onDragStart = function (e) {
                    ...
                    return!m.getReadOnly() && f(e.dataTransfer) ? (C = e.clientX, E = e.clientY, A || u(), _++, e.dataTransfer.dropEffect = x = p(e), s.preventDefault(e)) : void 0
                }, this.onDragOver = function (e) {
                    return!m.getReadOnly() && f(e.dataTransfer) ? (C = e.clientX, E = e.clientY, A || (u(), _++), null !== L && (L = null), e.dataTransfer.dropEffect = x = p(e), s.preventDefault(e)) : void 0
                }, this.onDragLeave = function (e) {
                    return _--, 0 >= _ && A ? (d(), x = null, s.preventDefault(e)) : void 0
                }, this.onDrop = function (e) {
                    if (b) {
                        var t = e.dataTransfer;
                        if (S)switch (x) {
                            case"move":
                                F = F.contains(b.row, b.column) ? {start: b, end: b} : m.moveText(F, b);
                                break;
                            case"copy":
                                F = m.moveText(F, b, !0)
                        } else {
                            var i = t.getData("Text");
                            F = {start: b, end: m.session.insert(b, i)}, m.focus(), x = null
                        }
            ...
            t.get = function (e) {
                ...
                var s = u[t + "Path"];
                return null == s ? s = u.basePath : "/" == n && (t = n = ""),
                    s && "/" != s.slice(-1) && (s += "/"), s + t + n + o + this.get("suffix")
                ...
                this.$setMaxTokenCount = function (e) {
                    ...
                    for (var l, c = [], h = 0, u = 0, d = {type: null, value: ""}; l = a.exec(e);) {
                        ...
                        for (var w = 0; w < l.length - 2; w++)if (void 0 !== l[w + 1]) {
                            f = r[s[w]], g = f.onMatch ? f.onMatch(p, o, i) : f.token, f.next && (o = "string" == typeof f.next ? f.next : f.next(o, i), r = this.states[o], r || (this.reportError("state doesn't exist", o), o = "start", r = this.states[o]), s = this.matchMappings[o], h = m, a = this.regExps[o], a.lastIndex = m);
                            break
                        }
                ...
                this.tokenRe = new RegExp("^[" + s.packages.L + s.packages.Mn + s.packages.Mc + s.packages.Nd + s.packages.Pc + "\\$_]+", "g"), this.nonTokenRe = new RegExp("^(?:[^" + s.packages.L + s.packages.Mn + s.packages.Mc + s.packages.Nd + s.packages.Pc + "\\$_]|\\s])+", "g"), this.getTokenizer = function () {
                    ...
                    if (this.lineCommentStart) {
                        ...
                        var f = function (e, t) {
                            ...
                            (!s || /\S/.test(e)) && (w(e, c, c) ? r.insertInLine({row: t, column: c}, p) : r.insertInLine({row: t, column: c}, g))
                        }, v = function (e, t) {
                            return d.test(e)
                        }, w = function (e, t, i) {
                        ...
                        var g = this.blockComment.start, A = this.blockComment.end, d = new RegExp("^(\\s*)(?:" + a.escapeRegExp(g) + ")"), C = new RegExp("(?:" + a.escapeRegExp(A) + ")\\s*$"), m = function (e, t) {
                            v(e, t) || (!s || /\S/.test(e)) && (r.insertInLine({row: t, column: e.length}, A), r.insertInLine({row: t, column: c}, g))
                        }, f = function (e, t) {
                            var i;
            ...
            (function () {
                ...
                n.implement(this, s), this.setDocument = function (e) {
                    ...
                    this.doc.setValue(e), this.selection.moveTo(0, 0),
                        this.$resetRowCache(0), this.$deltas = [], this.$deltasDoc = [], this.$deltasFold = [], this.setUndoManager(this.$undoManager), this.getUndoManager().reset()
            ...
            (function () {
                this.set = function (e) {
                    ...
                    } else for (var v = 0; v < o.length; v++)for (var w = n.getMatchOffsets(o[v], a), d = 0; d < w.length; d++) {
                        var A = w[d];
            ...
            t.commands = [
                ...
                {name: "gotoline", bindKey: n("Ctrl-L", "Command-L"),
                    exec: function (e) {
                ...
                n.implement(this, f), this.$initOperationListeners = function () {
                    ...
                    if (!this.$highlightTagPending) {
                        ...
                        this.$highlightTagPending = !0, setTimeout(function () {
                            ...
                            var t = e.session;
                            if (t && t.bgTokenizer) {
                                var i = e.getCursorPosition(), n = new w(e.session, i.row, i.column), o = n.getCurrentToken();
                    ...
                    i.insert(o, e);
                    if (r && r.selection && (2 == r.selection.length ? this.selection.setSelectionRange(new g(o.row, c + r.selection[0], o.row, c + r.selection[1])) : this.selection.setSelectionRange(new g(o.row + r.selection[0], r.selection[1], o.row + r.selection[2], r.selection[3]))), i.getDocument().isNewLine(e)) {
                    ...
                    var i = this.getCursorPosition(), n = new w(this.session, i.row, i.column), o = n.getCurrentToken(), r = o || n.stepForward();
                    if (r) {
            ...
            }).call(A.prototype), v.defineOptions(A.prototype, "editor", {selectionStyle: {set: function (e) {
            ...
            (function () {
                n.implement(this, s), this.EOF_CHAR = "¶", this.EOL_CHAR_LF = "¬", this.EOL_CHAR_CRLF = "¤", this.EOL_CHAR = this.EOL_CHAR_LF, this.TAB_CHAR = "→", this.SPACE_CHAR = "·", this.$padding = 0, this.$updateEolChar = function () {
                    ...
                    this.tabSize = e;
                    for (var t = this.$tabStrings = [0], i = 1; e + 1 > i; i++)this.showInvisibles ? t.push("<span class='ace_invisible ace_invisible_tab'>" + this.TAB_CHAR + r.stringRepeat(" ", i - 1) + "</span>") : t.push(r.stringRepeat(" ", i));
                    ...
                    function i(e, t, i) {
                        ...
                        for (; i > r && n < e.length;) {
                            var s = e[n].value;
                            s.length + r > i ? o.push({type: e[n].type, value: s.substring(0, i - r)}) : o.push(e[n]), r += s.length, n += 1
                        }
                    }
            ...
            (function () {
                this.CHANGE_CURSOR = 1, this.CHANGE_MARKER = 2, this.CHANGE_GUTTER = 4, this.CHANGE_SCROLL = 8, this.CHANGE_LINES = 16, this.CHANGE_TEXT = 32, this.CHANGE_SIZE = 64, this.CHANGE_MARKER_BACK = 128, this.CHANGE_MARKER_FRONT = 256, this.CHANGE_FULL = 512, this.CHANGE_H_SCROLL = 1024, n.implement(this, p), this.updateCharacterSize = function () {
                    ...
                    var g, f, p = Math.ceil(s / this.lineHeight) - 1, m = Math.max(0, Math.round((this.scrollTop - r) / this.lineHeight)), v = m + p, w = this.lineHeight;
                    ...
                    var C = 0;
                    return this.layerConfig.width != a && (C = this.CHANGE_H_SCROLL), (c || d) && (C = this.$updateCachedSize(!0, this.gutterWidth, t.width, t.height), this._signal("scrollbarVisibilityChanged"), d && (a = this.$getLongestLine())), this.layerConfig = {width: a, padding: this.$padding, firstRow: m, firstRowScreen: g, lastRow: v, lineHeight: w, characterWidth: this.characterWidth, minHeight: s, maxHeight: o, offset: r, gutterOffset: Math.max(0, Math.ceil((r + t.height - t.scrollerHeight) / w)), height: this.$size.scrollerHeight}, C
            ...
            function o(e) {
                ...
                if (0 === c) {
                    var h, u = e.editor, d = u.selection, g = u.inMultiSelectMode, f = e.getDocumentPosition(), p = d.getCursor(), m = e.inSelection() || d.isEmpty() && n(f, p), v = e.x, w = e.y, A = function (e) {
                        v = e.clientX, w = e.clientY
                    }, C = u.session, E = u.renderer.pixelToScreenCoordinates(v, w), y = E;
                    ...
                    if (h && s.isMac && t.ctrlKey && u.$mouseHandler.cancelContextMenu(), "add" == h) {
                        ...
                        u.$blockScrolling++, u.inVirtualSelectionMode = !0, o && (b = null, F = d.ranges[0], u.removeSelectionMarker(F)), u.once("mouseup", function () {
                            var e = d.toOrientedRange();
                            b && e.isEmpty() && n(b.cursor, e.cursor) ? d.substractPoint(e.cursor) : (o ? d.substractPoint(F.cursor) : F && (u.removeSelectionMarker(F), d.addRange(F)), d.addRange(e)), u.$blockScrolling--, u.inVirtualSelectionMode = !1
                        })
                    } else if ("block" == h) {
                        e.stop(), u.inVirtualSelectionMode = !0;
                        var x, S = [], D = function () {
                            var e = u.renderer.pixelToScreenCoordinates(v, w), t = C.screenToDocumentPosition(e.row, e.column);
                            n(y, e) && n(t, d.lead) || (y = e, u.selection.moveToPosition(t), u.renderer.scrollCursorIntoView(), u.removeSelectionMarkers(S), S = d.rectangularRangeBlock(y, E), u.$mouseHandler.$clickSelection && 1 == S.length && S[0].isEmpty() && (S[0] = u.$mouseHandler.$clickSelection.clone()), S.forEach(u.addSelectionMarker, u), u.updateSelectionMarkers())
                        };
                        g && !l ? d.toSingleRange() : !g && l && (x = d.toOrientedRange(), u.addSelectionMarker(x)), o ? E = C.documentToScreenPosition(d.lead) : d.moveToPosition(f), y = {row: -1, column: -1};
                        var B = function (e) {
            ...
            function r(e) {
                e.$multiselectOnSessionChange || (e.$onAddRange = e.$onAddRange.bind(e), e.$onRemoveRange = e.$onRemoveRange.bind(e), e.$onMultiSelect = e.$onMultiSelect.bind(e), e.$onSingleSelect = e.$onSingleSelect.bind(e), e.$multiselectOnSessionChange = t.onSessionChange.bind(e), e.$checkMultiselectChange = e.$checkMultiselectChange.bind(e), e.$multiselectOnSessionChange(e),
                    e.on("changeSession", e.$multiselectOnSessionChange), e.on("mousedown", h), e.commands.addCommands(g.defaultCommands), s(e))
            }
                ...
                this.add("braces", "insertion", function (e, t, i, o, r) {
                    ...
                    if ('"' == o || "'" == o) {
                        ...
                        if (g && "string" === g.type) {
                            ...
                            if (w == r)return{text: "", selection: [1, 1]}
                        }
                    }
...
var ajax = function () {
    function e(e, t, i, n, o) {
        try {
            ...
            }, r.open(e, t, !0), n)for (var s in n)n.hasOwnProperty(s) && r.setRequestHeader(s, n[s]);
            r.send(i)
        } catch (a) {
            o(a, null, 0)
        }
    ...
    return{fetch: e, get: t, post: i, put: n, del: o}
}();
Notify.prototype.showNotification = function (e, t) {
    ...
    if (!t) {
        var i = 500, n = 5, o = document.body.offsetWidth || window.innerWidth;
    ...
    var r = e.type || "notification", s = e.closeButton !== !1, a = document.createElement("div");
    ...
    if (r)util.prompt({title: "Open file", titleSubmit: "Open", description: "Select a file on your computer.", inputType: "file", inputName: "file", callback: function (e, t) {
        if (e) {
            if (r) {
        ...
        }, document.body.appendChild(a), util.prompt({title: "Open file", titleSubmit: "Open", description: "Select a file on your computer.", inputType: "file", inputName: "file", formAction: this.scriptUrl, formMethod: "POST", formTarget: s, callback: function (e) {
            e && n()
        }})
    }
}, FileRetriever.prototype.loadUrlDialog = function (e) {
    util.prompt({title: "Open url", titleSubmit: "Open", description: "Enter a public url. Urls which need authentication or are located on an intranet cannot be loaded.", inputType: "text", inputName: "url", inputDefault: this.getUrl(), callback: e})
}, FileRetriever.prototype.saveFile = function (e, t, i) {
    var n = t ? t + ".json" : this.defaultFilename, o = void 0;
    ...
    if (e) {
        ...
        ajax.put(this.url, l, c, function (e, i, a) {
            if (r.notify.removeMessage(o), 200 == a) {
                ...
                r.revs[c] = h, n(null, {name: s || null, _id: c, _rev: h})
...
app.doc = {name: null, _id: null, _rev: null}, app.lastChanged = void 0, app.changed = !1, app.autoSaveTimer = null, app.localSaveTimer = null, app.conflictMessages = [], app.codeToTree = function () {
    try {
    ...
    try {
        app.notify = new Notify, app.retriever = new FileRetriever({scriptUrl: "fileretriever.php", notify: app.notify}), app.store = new OnlineStore({url: "//api.jsoneditoronline.org/v1/docs/", notify: app.notify});
        var e = document.getElementById("codeEditor");
        codeEditor = new JSONEditor(e, {mode: "code", change: function () {
            app.setChanged(codeEditor)
        }, error: function (e) {
            app.notify.showError(app.formatError(e))
        }}), e = document.getElementById("treeEditor"), treeEditor = new JSONEditor(e, {mode: "tree", change: function () {
            app.setChanged(treeEditor)
        }, error: function (e) {
            app.notify.showError(app.formatError(e))
        }}), app.splitter = new Splitter({container: document.getElementById("drag"), change: function () {
            app.resize()
        }});
        ...
        o.href = document.location.pathname + "#new", o.onclick = function (e) {
        ...
        var c, h = new QueryParams, u = h.getValue("json"), d = h.getValue("url"), g = h.getValue("id"), f = "#new" == location.hash, p = "#open" == location.hash;
        if (g)app.openOnline(g); else if (u)codeEditor.setText(u), treeEditor.setText(u), app.changed = !1; else if (d)app.openUrl(d); else if (f)location.hash = "", codeEditor.setText(""), app.changed = !1; else if (p)location.hash = "", app.openFromDisk(); else if (void 0 !== (c = localStorage.data))codeEditor.setText(c), treeEditor.setText(c), app.changed = !1; else {
            var m = {array: [1, 2, 3], "boolean": !0, "null": null, number: 123, object: {a: "b", c: "d", e: "f"}, string: "Hello World"};
    ...
    function t(t, i) {
        console.log("url", e), t ? app.notify.showError(t) : i && (app.setData(i), app.setMetaData({name: util.getName(e)}))
    }
    ...
    if (app.sync(), app.doc.name && app.doc._id)app._saveOnline(); else {
        ...
        util.prompt({title: "Save online", titleSubmit: "Save", description: "Enter a name for the document.<br><br>The saved document is stored online and can be shared with others via an url.", inputType: "text", inputName: "filename", inputDefault: e, callback: function (e) {
            void 0 != e && (app.setMetaData({name: e}), app._saveOnline())
        }})
    }
}, app.saveLocal = function (e) {
    var t = localStorage.files, i = t ? JSON.parse(t) : {};
    i[e._id] = {_id: e._id, _rev: e._rev, name: e.name, updated: (new Date).toISOString()}, localStorage.files = JSON.stringify(i), app.showFilesList(i)
    ...
    if (app.lastFilesStr != t) {
        ...
        i.innerHTML = "", n.length > 0 && n.forEach(function (t) {
            var n = e[t], o = document.createElement("div");
            o.className = "file";
    ...
    var e = app.doc.name || null;
    util.prompt({title: "Rename file", titleSubmit: "Save", description: "Enter a new name for the document.", inputType: "text", inputName: "filename", inputDefault: e, callback: function (e) {
    ...
    app.store.remove(e, function (t, i) {
        if (t)app.notify.showError(t); else {
            var n = localStorage.files, o = n ? JSON.parse(n) : {};
            delete o[e._id], localStorage.files = JSON.stringify(o), app.doc._id == e._id ? (app.changed = !1, document.location.href = document.location.pathname + "#new") : app.showFilesList(o)
        }
    })
    ...
    util.prompt({title: "Save online", titleSubmit: "Save", description: "Enter a name for the document.<br><br>The saved document is stored online and can be shared with others via an url.", inputType: "text", inputName: "filename", inputDefault: e, callback: t})
}, app.formatError = function (e) {
    var t = e.toString().replace(/</g, "&lt;").replace(/>/g, "&gt;"), i = '<pre class="error">' + t + "</pre>";
    ...
    if (c && (l -= c + a), app.splitter) {
        ...
        var h = app.splitter.getValue(), u = h > 0, d = 1 > h, g = u && d;
        ...
        } else f = l * h - p, r.innerHTML = "&lsaquo;", r.title = "Drag left to show the tree editor"; else f = 0, r.innerHTML = "&rsaquo;", r.title = "Drag right to show the code editor";
