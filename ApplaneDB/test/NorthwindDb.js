...
exports.Tasks = [
    {_id:"task01", task:"task01", status:"New", estefforts:1, est_amt:{amount:10000, type:{currency:"INR"}}, est_hrs:{time:2, unit:"Hrs", convertedvalue:120}, businessfunctionid:{_id:"Delivery", businessfunction:"Delivery"}, "priorityid":{"_id":"High", "priority":"High"}, "assignto":[
        {_id:"Pawan"},
        {_id:"Rohit"}
    ]},
    {_id:"task02", task:"task02", status:"New", estefforts:2, est_amt:{amount:1000, type:{currency:"INR"}}, est_hrs:{time:3, unit:"Hrs", convertedvalue:180}, businessfunctionid:{_id:"Sales", businessfunction:"Sales"}, "priorityid":{"_id":"High", "priority":"High"}, "assignto":[
        {_id:"Ashish"},
        {_id:"Rohit"}
    ]},
    {_id:"task03", task:"task03", status:"InProgress", estefforts:3, est_amt:{amount:100, type:{currency:"INR"}}, est_hrs:{time:4, unit:"Hrs", convertedvalue:240}, businessfunctionid:{_id:"Delivery", businessfunction:"Delivery"}, "priorityid":{"_id":"Low", "priority":"Low"}, "assignto":[
        {_id:"Sachin"},
        {_id:"Rohit"}
    ]},
    {_id:"task04", task:"task04", status:"InProgress", estefforts:4, est_amt:{amount:20000, type:{currency:"INR"}}, est_hrs:{time:2, unit:"Hrs", convertedvalue:120}, businessfunctionid:{_id:"Sales", businessfunction:"Sales"}, "priorityid":{"_id":"High", "priority":"High"}, "assignto":[
        {_id:"Pawan"},
        {_id:"Sachin"}
    ]},
    {_id:"task05", task:"task05", status:"New", estefforts:5, est_amt:{amount:10000, type:{currency:"INR"}}, est_hrs:{time:2, unit:"Hrs", convertedvalue:120}, businessfunctionid:{_id:"Delivery", businessfunction:"Delivery"}, "priorityid":{"_id":"High", "priority":"High"}, "assignto":[
        {_id:"Sachin"},
        {_id:"Ashish"}
    ]},
    {_id:"task06", task:"task06", status:"InProgress", estefforts:6, est_amt:{amount:10000, type:{currency:"INR"}}, est_hrs:{time:2, unit:"Hrs", convertedvalue:120}, businessfunctionid:{_id:"Delivery", businessfunction:"Delivery"}, "priorityid":{"_id":"Medium", "priority":"Medium"}, "assignto":[
        {_id:"Pawan"},
        {_id:"Rohit"}
    ]},
    {_id:"task07", task:"task07", status:"New", estefforts:7, est_amt:{amount:10000, type:{currency:"INR"}}, est_hrs:{time:2, unit:"Hrs", convertedvalue:120}, businessfunctionid:{_id:"Delivery", businessfunction:"Delivery"}, "priorityid":{"_id":"High", "priority":"High"}, "assignto":[
        {_id:"Pawan"}
    ]},
    {_id:"task08", task:"task08", status:"New", estefforts:8, est_amt:{amount:50000, type:{currency:"INR"}}, est_hrs:{time:2, unit:"Hrs", convertedvalue:120}, businessfunctionid:{_id:"Sales", businessfunction:"Sales"}, "priorityid":{"_id":"Medium", "priority":"Medium"}, "assignto":[
        {_id:"Rohit"}
    ]},
    {_id:"task09", task:"task09", status:"Completed", estefforts:9, est_amt:{amount:10000, type:{currency:"INR"}}, est_hrs:{time:2, unit:"Hrs", convertedvalue:120}, businessfunctionid:{_id:"Accounts", businessfunction:"Accounts"}, "priorityid":{"_id":"High", "priority":"High"}, "assignto":[
        {_id:"Pawan"},
        {_id:"Rohit"}
    ]},
    {_id:"task10", task:"task10", status:"Completed", estefforts:10, est_amt:{amount:10000, type:{currency:"INR"}}, est_hrs:{time:2, unit:"Hrs", convertedvalue:120}, businessfunctionid:{_id:"Accounts", businessfunction:"Accounts"}, "priorityid":{"_id":"High", "priority":"High"}, "assignto":[
        {_id:"Sachin"}
    ]},
    {_id:"task11", task:"task11", status:"Completed", estefforts:11, est_amt:{amount:20000, type:{currency:"INR"}}, est_hrs:{time:2, unit:"Hrs", convertedvalue:120}, businessfunctionid:{_id:"HR", businessfunction:"HR"}, "priorityid":{"_id":"Low", "priority":"Low"}, "assignto":[
        {_id:"Pawan"},
        {_id:"Rohit"}
    ]},
    {_id:"task12", task:"task12", status:"Completed", estefforts:12, est_amt:{amount:10000, type:{currency:"INR"}}, est_hrs:{time:2, unit:"Hrs", convertedvalue:120}, businessfunctionid:{_id:"HR", businessfunction:"HR"}, "priorityid":{"_id":"High", "priority":"High"}, "assignto":[
        {_id:"Pawan"},
        {_id:"Rohit"}
    ]}
]
